...
/**
 * @brief Operation Plus State Class.
 */
class OperationPlusStateImpl extends OperationNormalStateImpl {
     ...
     */
    public OperationPlusStateImpl(OperationData operation_data) {
