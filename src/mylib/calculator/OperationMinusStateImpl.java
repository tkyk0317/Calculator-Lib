...
/**
 * @brief Operation Minus State Class.
 */
class OperationMinusStateImpl extends OperationNormalStateImpl {
     ...
     */
    public OperationMinusStateImpl(OperationData operation_data) {
