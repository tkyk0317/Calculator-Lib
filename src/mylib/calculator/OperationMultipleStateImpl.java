...
/**
 * @brief Operation Multiple State Class.
 */
class OperationMultipleStateImpl extends OperationNormalStateImpl {
     ...
     */
    public OperationMultipleStateImpl(OperationData operation_data) {
